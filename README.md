...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./public/assets/brand/light-logo.png">
    <source media="(prefers-color-scheme: light)" srcset="./public/assets/brand/dark-logo.png">
    <img alt="CFUpload Logo" src="./public/assets/brand/dark-logo.png" width="300">
  </picture>
</p>
